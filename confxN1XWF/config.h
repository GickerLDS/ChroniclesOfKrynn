...
/* Define to 1 if you have the declaration of `struct timeval', and to 0 if
   you don't. */
...
/* Define if json-c library is available */
...
/* Define if struct in_addr is available */
...
/* Define socklen_t as int if not available */
/* #undef socklen_t */
