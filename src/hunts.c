...
void load_hunts(void)
{
  ...
  add_hunt(HUNT_TYPE_BASILISK, 10, "basilisk",
           "This squat, reptilian monster has eight legs, bony spurs jutting from its back, and "
           "eyes that glow with pale green fire.",
           "A squat, reptilian basilisk is here feeding on a dead animal.", CLASS_WARRIOR,
           TRUE_NEUTRAL, RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_BASILISK, HUNT_ABIL_PETRIFY);

  add_hunt(HUNT_TYPE_MANTICORE, 10, "manticore",
           "This creature has a vaguely humanoid head, the body of a lion, and the wings of a "
           "dragon. Its tail ends in long, sharp spikes.",
           "A large manticore is here staring at you menacingly.", CLASS_WARRIOR, LAWFUL_EVIL,
           RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_MANTICORE, HUNT_ABIL_TAIL_SPIKES);

  add_hunt(HUNT_TYPE_WRAITH, 10, "wraith",
           "This ghostly creature is little more than a dark shape with two flickering pinpoints "
           "of light where its eyes should be.",
           "A dark, ghostly wraith floats ominously before you.", CLASS_WARRIOR, LAWFUL_EVIL,
           RACE_TYPE_UNDEAD, SUBRACE_INCORPOREAL, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_WRAITH, HUNT_ABIL_LEVEL_DRAIN);

  add_hunt(HUNT_TYPE_SIREN, 10, "siren",
           "This creature has the body of a hawk and the head of a beautiful woman with long, "
           "shining hair.",
           "A beautiful siren sits before you singing a haunting song.", CLASS_BARD,
           CHAOTIC_NEUTRAL, RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SUBRACE_UNKNOWN, SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_SIREN, HUNT_ABIL_CHARM);
  add_hunt_ability(HUNT_TYPE_SIREN, HUNT_ABIL_CAUSE_FEAR);

  add_hunt(HUNT_TYPE_WILL_O_WISP, 10, "will o wisp",
           "This faintly glowing ball of light bobs gently in the air, the nebulous image of what "
           "might be a skull visible somewhere in its depths.",
           "A faintly glowing will o\' wisp floats before you.", CLASS_WARRIOR, CHAOTIC_EVIL,
           RACE_TYPE_ABERRATION, SUBRACE_AIR, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_SMALL);
  add_hunt_ability(HUNT_TYPE_WILL_O_WISP, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_WILL_O_WISP, HUNT_ABIL_MAGIC_IMMUNITY);
  add_hunt_ability(HUNT_TYPE_WILL_O_WISP, HUNT_ABIL_INVISIBILITY);

  add_hunt(HUNT_TYPE_BARGHEST, 15, "barghest",
           "This snarling, canine beast pads forward on all fours, its slender front limbs looking "
           "more like hands than a wolf’s paws.",
           "A large, snarling barghest paces the ground before you.", CLASS_WARRIOR, LAWFUL_EVIL,
           RACE_TYPE_OUTSIDER, SUBRACE_EVIL, SUBRACE_SHAPECHANGER, SUBRACE_LAWFUL, SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_BARGHEST, HUNT_ABIL_CHARM);
  add_hunt_ability(HUNT_TYPE_BARGHEST, HUNT_ABIL_BLINK);
  add_hunt_ability(HUNT_TYPE_BARGHEST, HUNT_ABIL_CAUSE_FEAR);

  add_hunt(HUNT_TYPE_BLACK_PUDDING, 15, "black pudding",
           "This black, amorphous blob piles up on itself, a quivering mound of midnight sludge "
           "that glistens darkly before surging forward.",
           "A huge, amorphus black pudding blob glistens darkly.", CLASS_WARRIOR, TRUE_NEUTRAL,
           RACE_TYPE_OOZE, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_BLACK_PUDDING, HUNT_ABIL_ENGULF);

  add_hunt(HUNT_TYPE_CHIMERA, 15, "chimera",
           "This winged monster has the body of a lion, though two more heads flank its central "
           "feline one—a dragon and a horned goat.",
           "A three-headed, winged chimera roars loadly.", CLASS_WARRIOR, CHAOTIC_EVIL,
           RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_CHIMERA, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_CHIMERA, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_GHOST, 15, "ghost",
           "This spectral, horrifying figure glides silently through the air, passing through "
           "solid objects as if they didn’t exist.",
           "A translucent ghost floats around in front of you.", CLASS_WARRIOR, LAWFUL_GOOD,
           RACE_TYPE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_FINE);
  add_hunt_ability(HUNT_TYPE_GHOST, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_GHOST, HUNT_ABIL_CORRUPTION);
  add_hunt_ability(HUNT_TYPE_GHOST, HUNT_ABIL_REGENERATION);

  add_hunt(HUNT_TYPE_MEDUSA, 15, "medusa",
           "This slender, attractive woman has strangely glowing eyes and a full head of hissing "
           "snakes for hair.",
           "A terrifying medusa grins an evil grin.", CLASS_WARRIOR, LAWFUL_EVIL,
           RACE_TYPE_MONSTROUS_HUMANOID, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_MEDUSA, HUNT_ABIL_PETRIFY);
  add_hunt_ability(HUNT_TYPE_MEDUSA, HUNT_ABIL_POISON);

  add_hunt(HUNT_TYPE_BEHIR, 20, "behir",
           "This slithering, multilegged blue reptile has a fearsome head crowned with two large, "
           "curling horns.",
           "A long, slithering blue behir sparks lightning from its maw.", CLASS_WARRIOR,
           TRUE_NEUTRAL, RACE_TYPE_MAGICAL_BEAST, SUBRACE_REPTILIAN, SUBRACE_UNKNOWN,
           SUBRACE_UNKNOWN, SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_BEHIR, HUNT_ABIL_LIGHTNING_BREATH);

  add_hunt(HUNT_TYPE_EFREETI, 20, "efreeti",
           "This muscular giant has crimson skin, smoldering eyes, and small black horns. Smoke "
           "rises in curls from its flesh.",
           "A giant flaming efreeti smolders the ground here.", CLASS_SORCERER, LAWFUL_EVIL,
           RACE_TYPE_OUTSIDER, SUBRACE_EXTRAPLANAR, SUBRACE_FIRE, SUBRACE_UNKNOWN, SIZE_LARGE);

  add_hunt(HUNT_TYPE_DJINNI, 20, "djinni",
           "This creature stands nearly twice as tall as a human, although its lower torso trails "
           "away into a vortex of mist and wind.",
           "A towering djinni gazes sternly from a cloud of thunder and mist.", CLASS_SORCERER,
           CHAOTIC_GOOD, RACE_TYPE_OUTSIDER, SUBRACE_EXTRAPLANAR, SUBRACE_AIR, SUBRACE_UNKNOWN,
           SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_DJINNI, HUNT_ABIL_FLIGHT);

  add_hunt(HUNT_TYPE_YOUNG_RED_DRAGON, 20, "young red dragon",
           "A crown of cruel horns surrounds the head of this mighty dragon. Thick scales the "
           "color of molten rock cover its long body.",
           "A young red dragon snorts flame from its nostrils.", CLASS_SORCERER, CHAOTIC_EVIL,
           RACE_TYPE_DRAGON, SUBRACE_FIRE, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_YOUNG_RED_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_YOUNG_RED_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_YOUNG_RED_DRAGON, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_ADULT_RED_DRAGON, 25, "adult red dragon",
           "A crown of cruel horns surrounds the head of this mighty dragon. Thick scales the "
           "color of molten rock cover its long body.",
           "An adult red dragon snorts flame from its nostrils.", CLASS_SORCERER, CHAOTIC_EVIL,
           RACE_TYPE_DRAGON, SUBRACE_FIRE, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_ADULT_RED_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_ADULT_RED_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_ADULT_RED_DRAGON, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_OLD_RED_DRAGON, 30, "old red dragon",
           "A crown of cruel horns surrounds the head of this mighty dragon. Thick scales the "
           "color of molten rock cover its long body.",
           "An old red dragon snorts flame from its nostrils.", CLASS_SORCERER, CHAOTIC_EVIL,
           RACE_TYPE_DRAGON, SUBRACE_FIRE, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_OLD_RED_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_OLD_RED_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_OLD_RED_DRAGON, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_YOUNG_BLUE_DRAGON, 20, "young blue dragon",
           "With scales the color of the desert sky, this large, serpentine dragon moves with an "
           "unsettling grace.",
           "A young blue dragon seethes lightning from its toothy maw.", CLASS_SORCERER,
           LAWFUL_EVIL, RACE_TYPE_DRAGON, SUBRACE_AIR, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_YOUNG_BLUE_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_YOUNG_BLUE_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_YOUNG_BLUE_DRAGON, HUNT_ABIL_LIGHTNING_BREATH);

  add_hunt(HUNT_TYPE_ADULT_BLUE_DRAGON, 25, "adult blue dragon",
           "With scales the color of the desert sky, this large, serpentine dragon moves with an "
           "unsettling grace.",
           "An adult blue dragon seethes lightning from its toothy maw.", CLASS_SORCERER,
           LAWFUL_EVIL, RACE_TYPE_DRAGON, SUBRACE_AIR, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_ADULT_BLUE_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_ADULT_BLUE_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_ADULT_BLUE_DRAGON, HUNT_ABIL_LIGHTNING_BREATH);

  add_hunt(HUNT_TYPE_OLD_BLUE_DRAGON, 30, "old blue dragon",
           "With scales the color of the desert sky, this large, serpentine dragon moves with an "
           "unsettling grace.",
           "An old blue dragon seethes lightning from its toothy maw.", CLASS_SORCERER, LAWFUL_EVIL,
           RACE_TYPE_DRAGON, SUBRACE_AIR, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_OLD_BLUE_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_OLD_BLUE_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_OLD_BLUE_DRAGON, HUNT_ABIL_LIGHTNING_BREATH);

  add_hunt(HUNT_TYPE_YOUNG_GREEN_DRAGON, 20, "young green dragon",
           "Scales the color of emeralds armor this ferocious dragon. A single sharp horn "
           "protrudes from the end of its toothy snout.",
           "A young green dragon drips hissing poison from its toothy maw.", CLASS_SORCERER,
           LAWFUL_EVIL, RACE_TYPE_DRAGON, SUBRACE_EARTH, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_LARGE);
  add_hunt_ability(HUNT_TYPE_YOUNG_GREEN_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_YOUNG_GREEN_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_YOUNG_GREEN_DRAGON, HUNT_ABIL_POISON_BREATH);

  add_hunt(HUNT_TYPE_ADULT_GREEN_DRAGON, 25, "adult green dragon",
           "Scales the color of emeralds armor this ferocious dragon. A single sharp horn "
           "protrudes from the end of its toothy snout.",
           "An adult green dragon drips hissing poison from its toothy maw.", CLASS_SORCERER,
           LAWFUL_EVIL, RACE_TYPE_DRAGON, SUBRACE_EARTH, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_ADULT_GREEN_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_ADULT_GREEN_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_ADULT_GREEN_DRAGON, HUNT_ABIL_POISON_BREATH);

  add_hunt(HUNT_TYPE_OLD_GREEN_DRAGON, 30, "old green dragon",
           "Scales the color of emeralds armor this ferocious dragon. A single sharp horn "
           "protrudes from the end of its toothy snout.",
           "An old green dragon drips hissing poison from its toothy maw.", CLASS_SORCERER,
           LAWFUL_EVIL, RACE_TYPE_DRAGON, SUBRACE_EARTH, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_OLD_GREEN_DRAGON, HUNT_ABIL_CAUSE_FEAR);
  add_hunt_ability(HUNT_TYPE_OLD_GREEN_DRAGON, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_OLD_GREEN_DRAGON, HUNT_ABIL_POISON_BREATH);

  add_hunt(HUNT_TYPE_YOUNG_WHITE_DRAGON, 20, "young white dragon",
           "This dragon’s scales are a frosty white. Its head is crowned with slender horns, with "
           "a thin membrane stretched between them.",
           "A young white dragon breathes frigid frost from its nostrils.", CLASS_SORCERER,
           CHAOTIC_EVIL, RACE_TYPE_DRAGON, SUBRACE_COLD, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_LARGE);
  ...
  add_hunt(HUNT_TYPE_ADULT_WHITE_DRAGON, 25, "adult white dragon",
           "This dragon’s scales are a frosty white. Its head is crowned with slender horns, with "
           "a thin membrane stretched between them.",
           "An adult white dragon breathes frigid frost from its nostrils.", CLASS_SORCERER,
           CHAOTIC_EVIL, RACE_TYPE_DRAGON, SUBRACE_COLD, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_HUGE);
  ...
  add_hunt(HUNT_TYPE_OLD_WHITE_DRAGON, 30, "old white dragon",
           "This dragon’s scales are a frosty white. Its head is crowned with slender horns, with "
           "a thin membrane stretched between them.",
           "An old white dragon breathes frigid frost from its nostrils.", CLASS_SORCERER,
           CHAOTIC_EVIL, RACE_TYPE_DRAGON, SUBRACE_COLD, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_GARGANTUAN);
  ...
  add_hunt(
      ...
      "A massive dragon turtle lumbers with thundering steps.", CLASS_WARRIOR, TRUE_NEUTRAL,
      RACE_TYPE_DRAGON, SUBRACE_AQUATIC, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_DRAGON_TURTLE, HUNT_ABIL_SWALLOW);
  add_hunt_ability(HUNT_TYPE_DRAGON_TURTLE, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_ROC, 25, "roc",
           "This immense raptor unleashes a shrill cry as it bares its talons, each large enough "
           "to carry off a horse.",
           "A massive roc, a huge flying bird of prey, sits majestically before you.",
           CLASS_WARRIOR, TRUE_NEUTRAL, RACE_TYPE_ANIMAL, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SUBRACE_UNKNOWN, SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_ROC, HUNT_ABIL_FLIGHT);
  add_hunt_ability(HUNT_TYPE_ROC, HUNT_ABIL_GRAPPLE);

  add_hunt(HUNT_TYPE_PURPLE_WORM, 25, "purple worm",
           "This enormous worm is covered with dark purple plates of chitinous armor. Its giant, "
           "tooth-filled mouth is the size of an ox.",
           "A massive purple worm opens its huge maw, filled with razor sharp teeth.",
           CLASS_WARRIOR, TRUE_NEUTRAL, RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SUBRACE_UNKNOWN, SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_PURPLE_WORM, HUNT_ABIL_SWALLOW);
  add_hunt_ability(HUNT_TYPE_PURPLE_WORM, HUNT_ABIL_POISON);

  add_hunt(HUNT_TYPE_PYROHYDRA, 30, "pyrohydra",
           "Multiple angry snake-like heads rise from the sleek, serpentine body of this "
           "terrifying monster.",
           "A seven-headed, fire breathing pyrohydra threatens all in its sight.", CLASS_WARRIOR,
           TRUE_NEUTRAL, RACE_TYPE_MAGICAL_BEAST, SUBRACE_FIRE, SUBRACE_REPTILIAN, SUBRACE_UNKNOWN,
           SIZE_HUGE);
  add_hunt_ability(HUNT_TYPE_PYROHYDRA, HUNT_ABIL_REGENERATION);
  add_hunt_ability(HUNT_TYPE_PYROHYDRA, HUNT_ABIL_FIRE_BREATH);

  add_hunt(HUNT_TYPE_BANDERSNATCH, 30, "bandersnatch",
           "This six-limbed beast stalks forward with a fluid grace. Barbed quills run along its "
           "back, and its eyes glow with a blue light.",
           "A massive six-limbed bandersnatch emanates waves of fear.", CLASS_WARRIOR, TRUE_NEUTRAL,
           RACE_TYPE_MAGICAL_BEAST, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_GARGANTUAN);
  add_hunt_ability(HUNT_TYPE_BANDERSNATCH, HUNT_ABIL_TAIL_SPIKES);
  add_hunt_ability(HUNT_TYPE_BANDERSNATCH, HUNT_ABIL_CHARM);
  add_hunt_ability(HUNT_TYPE_BANDERSNATCH, HUNT_ABIL_REGENERATION);
  add_hunt_ability(HUNT_TYPE_BANDERSNATCH, HUNT_ABIL_PARALYZE);

  add_hunt(HUNT_TYPE_BANSHEE, 30, "banshee",
           "This beautiful, ghostly elven woman glides through the air, her long hair flowing "
           "around a face knotted into a mask of rage.",
           "A beautiful, ghostly banshee wails with horrendous pain and malice.", CLASS_SORCERER,
           CHAOTIC_EVIL, RACE_TYPE_UNDEAD, SUBRACE_INCORPOREAL, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN,
           SIZE_MEDIUM);
  add_hunt_ability(HUNT_TYPE_BANSHEE, HUNT_ABIL_LEVEL_DRAIN);
  add_hunt_ability(HUNT_TYPE_BANSHEE, HUNT_ABIL_CAUSE_FEAR);
}
...
SPECIAL(huntsmaster)
{
  if (!CMD_IS("hunts") && !CMD_IS("list") && !CMD_IS("exchange"))
    return 0;
  ...
  if (CMD_IS("hunts"))
  {
    ...
    for (i = 0; i < 5; i++)
    {
      ...
      send_to_char(ch, "%-20s %-5d %s%s\r\n", hunt_table[active_hunts[i][0]].name,
                   hunt_table[active_hunts[i][0]].level,
    ...
    send_to_char(ch, "\r\nTime until next hunt targets: %d hour(s), %d minute(s), %d seconds",
  ...
  if (CMD_IS("hunts"))
  {
    ...
    send_to_char(ch, "%-20s %-5s %-16s %s\r\n", "Hunt Target", "Level", "Last Seen Coords",
                 (GET_LEVEL(ch) >= LVL_IMMORT) ? "Actual Coords" : "");
    send_to_char(ch, "---------------------------------------------------------\r\n");
    ...
    for (i = 0; i < 5; i++)
    {
      ...
      send_to_char(ch, "%-20s %-5d %-16s %s\r\n", hunt_table[active_hunts[i][0]].name,
                   hunt_table[active_hunts[i][0]].level, reported,
                   (GET_LEVEL(ch) >= LVL_IMMORT) ? actual : "");
    }
  ...
  else if (CMD_IS("exchange"))
  {
    if (!*arg1)
    {
      send_to_char(ch, "You need to specify the hunt trophies you want to exchange.  You'll need "
                       "ten of them to complete the exchange.\r\n");
      return 1;
    }
    ...
    {
      if (GET_OBJ_VNUM(obj2) == GET_OBJ_VNUM(obj1))
        count++;
    }
    if (count < 10)
    {
    ...
    if (trinket)
    {
      ...
      {
        send_to_char(ch,
                     "You need to specify whether you want a ring, a pendant or a bracer with the "
                     "%s enchantment.\r\n",
      ...
      {
        send_to_char(
            ch, "There was an issue.  Please inform staff using error code HUNTEXCHANGE001.\r\n");
        return 1;
      }
    ...
    else
    {
      ...
      {
        send_to_char(
            ch, "There was an issue.  Please inform staff using error code HUNTEXCHANGE002.\r\n");
        return 1;
      }
...
void drop_hunt_mob_rewards(struct char_data *ch, struct char_data *hunt_mob)
{
  ...
  if (IN_ROOM(ch) == NOWHERE || IN_ROOM(hunt_mob) == NOWHERE)
    return;
...
bool is_hunt_mob_in_room(room_rnum room, int which_hunt)
{
  ...
  {
    if (!IS_NPC(tch) || !MOB_FLAGGED(tch, MOB_HUNTS_TARGET))
      continue;
    if (tch->mob_specials.hunt_type == which_hunt)
      return true;
  }
  return false;
}
...
bool weapon_specab_desc_position(int specab)
{
  ...
  case WEAPON_SPECAB_DEFENDING:
    return true;
  case WEAPON_SPECAB_EXHAUSTING:
    return false;
  case WEAPON_SPECAB_CORROSIVE:
    return true;
  case WEAPON_SPECAB_SPEED:
    return false;
  case WEAPON_SPECAB_GHOST_TOUCH:
    return true;
  ...
  case WEAPON_SPECAB_AGILE:
    return true;
  case WEAPON_SPECAB_WOUNDING:
    return false;
  case WEAPON_SPECAB_LUCKY:
    return true;
...
int obj_vnum_to_hunt_type(int vnum)
{
  ...
  case 60000:
  case 60001:
    return HUNT_TYPE_BASILISK;
  case 60002:
  case 60003:
    return HUNT_TYPE_MANTICORE;
  case 60004:
  case 60005:
    return HUNT_TYPE_WRAITH;
  case 60006:
  case 60007:
    return HUNT_TYPE_SIREN;
  case 60008:
  case 60009:
  ...
  case 60014:
  case 60015:
    return HUNT_TYPE_CHIMERA;
  case 60016:
  case 60017:
    return HUNT_TYPE_GHOST;
  case 60018:
  case 60019:
    return HUNT_TYPE_MEDUSA;
  case 60020:
  case 60021:
    return HUNT_TYPE_BEHIR;
  case 60022:
  case 60023:
    return HUNT_TYPE_EFREETI;
  case 60024:
  case 60025:
    return HUNT_TYPE_DJINNI;
  case 60039:
    return HUNT_TYPE_YOUNG_WHITE_DRAGON;
  case 60041:
    return HUNT_TYPE_ADULT_GREEN_DRAGON;
  case 60042:
    return HUNT_TYPE_OLD_WHITE_DRAGON;
  case 60040:
  case 60043:
    return HUNT_TYPE_DRAGON_TURTLE;
  case 60029:
  case 60030:
    return HUNT_TYPE_ROC;
  case 60031:
  case 60032:
    return HUNT_TYPE_PURPLE_WORM;
  case 60033:
  case 60034:
    return HUNT_TYPE_PYROHYDRA;
  case 60035:
  case 60036:
