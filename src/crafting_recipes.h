...
#define CRAFT_RECIPE_WEAPON_ATHAME 146
#define CRAFT_RECIPE_WEAPON_ESTOC 147
#define CRAFT_RECIPE_WEAPON_FAUCHARD 148
#define CRAFT_RECIPE_WEAPON_ELVEN_CURVE_BLADE 149
#define CRAFT_RECIPE_WEAPON_FALCATA 150

#define NUM_CRAFTING_RECIPES 151
...
#define REFINE_RECIPE_DRAGONMETAL 8
#define REFINE_RECIPE_CATALYST 9

#define NUM_REFINING_RECIPES 10
...
struct craft_recipe_data
{
  ...
  int object_subtype;
  int variant_skill
      [NUM_CRAFT_VARIANTS]; // variants of the type. Eg. bracelet, bracer and wristguard
  int materials
      [3][NUM_CRAFT_VARIANTS]
      [2]; // type and num units required Eg. bracelet needs soft metal 5 units, bracer needs leather 7 units
