...
#define WEAPON_TYPE_ESTOC 80
#define WEAPON_TYPE_FAUCHARD 81
#define WEAPON_TYPE_ELVEN_CURVE_BLADE 82
#define WEAPON_TYPE_FALCATA 83
// One higher than last above
#define NUM_WEAPON_TYPES 84
