...
void populate_refining_recipes(void)
{
 ...
 refine_recipe(REFINE_RECIPE_DRAGONMETAL, ABILITY_HARVEST_MINING, 30, CRAFT_MAT_DRAGONBLOOD, 1, CRAFT_MAT_IRON, 2, 0, 0, CRAFT_MAT_DRAGONMETAL, 1, ITEM_CRAFTING_SMELTER);
 refine_recipe(REFINE_RECIPE_CATALYST, ABILITY_CRAFT_ALCHEMY, 25, CRAFT_MAT_CATALYST_FRAGMENT, 10, 0, 0, 0, 0, CRAFT_MAT_CATALYST, 1, ITEM_CRAFTING_ALCHEMY_LAB);
}
...
void populate_crafting_recipes(void)
{
  ...
  craft_recipe(CRAFT_RECIPE_WEAPON_ATHAME, ITEM_WEAPON, WEAPON_TYPE_ATHAME, "athame", WEAPON_TYPE_ATHAME);
    cvariant(CRAFT_RECIPE_WEAPON_ATHAME, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 5, CRAFT_GROUP_HIDES, 1, 0, 0, "athame");
  ...
  craft_recipe(CRAFT_RECIPE_WEAPON_RAPIER, ITEM_WEAPON, WEAPON_TYPE_RAPIER, "rapier", WEAPON_TYPE_RAPIER);
    ...
    cvariant(CRAFT_RECIPE_WEAPON_RAPIER, 1, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 4, CRAFT_GROUP_HIDES, 1, 0, 0, "foil");
    cvariant(CRAFT_RECIPE_WEAPON_RAPIER, 2, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 4, CRAFT_GROUP_HIDES, 1, 0, 0, "epee");
  craft_recipe(CRAFT_RECIPE_WEAPON_ESTOC, ITEM_WEAPON, WEAPON_TYPE_ESTOC, "estoc", WEAPON_TYPE_ESTOC);
    cvariant(CRAFT_RECIPE_WEAPON_ESTOC, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 6, CRAFT_GROUP_HIDES, 1, 0, 0, "estoc");
  craft_recipe(CRAFT_RECIPE_WEAPON_SCIMITAR, ITEM_WEAPON, WEAPON_TYPE_SCIMITAR, "scimitar", WEAPON_TYPE_SCIMITAR);
    ...
    cvariant(CRAFT_RECIPE_WEAPON_SCIMITAR, 1, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 5, CRAFT_GROUP_HIDES, 1, 0, 0, "zulfiqar");
    cvariant(CRAFT_RECIPE_WEAPON_SCIMITAR, 2, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 5, CRAFT_GROUP_HIDES, 1, 0, 0, "dadao");
    cvariant(CRAFT_RECIPE_WEAPON_SCIMITAR, 3, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 5, CRAFT_GROUP_HIDES, 1, 0, 0, "kopis");
  craft_recipe(CRAFT_RECIPE_WEAPON_FALCATA, ITEM_WEAPON, WEAPON_TYPE_FALCATA, "falcata", WEAPON_TYPE_FALCATA);
    cvariant(CRAFT_RECIPE_WEAPON_FALCATA, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 6, CRAFT_GROUP_HIDES, 1, 0, 0, "falcata");
  ...
  craft_recipe(CRAFT_RECIPE_WEAPON_FAUCHARD, ITEM_WEAPON, WEAPON_TYPE_FAUCHARD, "fauchard", WEAPON_TYPE_FAUCHARD);
    cvariant(CRAFT_RECIPE_WEAPON_FAUCHARD, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 7, CRAFT_GROUP_HIDES, 1, 0, 0, "fauchard");
  ...
  craft_recipe(CRAFT_RECIPE_WEAPON_ELVEN_CURVE_BLADE, ITEM_WEAPON, WEAPON_TYPE_ELVEN_CURVE_BLADE, "elven curve blade", WEAPON_TYPE_ELVEN_CURVE_BLADE);
    cvariant(CRAFT_RECIPE_WEAPON_ELVEN_CURVE_BLADE, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 8, CRAFT_GROUP_HIDES, 1, 0, 0, "elven curve blade");
  ...
  craft_recipe(CRAFT_RECIPE_WEAPON_FOOTMANS_LANCE, ITEM_WEAPON, WEAPON_TYPE_FOOTMANS_LANCE, "footmans lance", WEAPON_TYPE_FOOTMANS_LANCE);
    cvariant(CRAFT_RECIPE_WEAPON_FOOTMANS_LANCE, 0, CRAFT_SKILL_WEAPONSMITH, CRAFT_GROUP_HARD_METALS, 7, CRAFT_GROUP_HIDES, 1, 0, 0, "footman's lance");
  craft_recipe(CRAFT_RECIPE_ARMOR_CLOTHING, ITEM_ARMOR, SPEC_ARMOR_TYPE_CLOTHING, "clothing chest piece", SPEC_ARMOR_TYPE_CLOTHING);
    ...
    cvariant(CRAFT_RECIPE_ARMOR_CLOTHING, 8, CRAFT_SKILL_TAILOR, CRAFT_GROUP_CLOTH, 5, CRAFT_GROUP_HIDES, 1, 0, 0, "blouse");
  ...
  craft_recipe(CRAFT_RECIPE_ARMOR_CLOTHING_HEAD, ITEM_ARMOR, SPEC_ARMOR_TYPE_CLOTHING_HEAD, "clothing helm", SPEC_ARMOR_TYPE_CLOTHING_HEAD);
    ...
    cvariant(CRAFT_RECIPE_ARMOR_CLOTHING_HEAD, 7, CRAFT_SKILL_JEWELER, CRAFT_GROUP_SOFT_METALS, 3, 0, 0, 0, 0, "circlet");
    cvariant(CRAFT_RECIPE_ARMOR_CLOTHING_HEAD, 8, CRAFT_SKILL_JEWELER, CRAFT_GROUP_SOFT_METALS, 3, 0, 0, 0, 0, "crown");
    cvariant(CRAFT_RECIPE_ARMOR_CLOTHING_HEAD, 9, CRAFT_SKILL_TAILOR, CRAFT_GROUP_CLOTH, 2, CRAFT_GROUP_HIDES, 1, 0, 0, "headband");
  ...
  craft_recipe(CRAFT_RECIPE_MISC_BOOTS, ITEM_WORN, ITEM_WEAR_FEET, "boots", CRAFT_MISC_BOOTS);
    ...
    cvariant(CRAFT_RECIPE_MISC_BOOTS, 7, CRAFT_SKILL_TAILOR, CRAFT_GROUP_HIDES, 3, CRAFT_GROUP_HARD_METALS, 1, 0, 0, "sandals");
  ...
  craft_recipe(CRAFT_RECIPE_MISC_CLOAK, ITEM_WORN, ITEM_WEAR_ABOUT, "cloak", CRAFT_MISC_CLOAK);
    ...
    cvariant(CRAFT_RECIPE_MISC_CLOAK, 8, CRAFT_SKILL_TAILOR, CRAFT_GROUP_CLOTH, 4, CRAFT_GROUP_HIDES, 1, CRAFT_GROUP_SOFT_METALS, 1, "shawl");
  ...
  craft_recipe(CRAFT_RECIPE_MISC_ANKLET, ITEM_WORN, ITEM_WEAR_ANKLE, "anklet", CRAFT_MISC_ANKLET);
    ...
    cvariant(CRAFT_RECIPE_MISC_ANKLET, 1, CRAFT_SKILL_JEWELER, CRAFT_GROUP_SOFT_METALS, 1, 0, 0, 0, 0, "ankle chain");
