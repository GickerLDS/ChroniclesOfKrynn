                              ...
                              bool filter_available, bool filter_in_game, bool include_disabled)
{
  ...
  for (i = 1; i < TALENT_MAX; i++)
  {
    ...
    if (filter_in_game && !talent_list[i].in_game)
      continue;

    /* Skip if disabled and we're not including disabled */
    if (!include_disabled && !talent_list[i].in_game)
      continue;

    /* Skip if filtering for available and player can't afford it */
    if (filter_available && !can_learn_talent(ch, i))
      continue;
...
static void talento(int talent, const char *name, int base_point_cost, int base_gold_cost,
                    int max_ranks, const char *short_desc, const char *long_desc, bool in_game,
                    int category)
{
...
void init_talents(void)
{
  ...
  talento(TALENT_SCAVENGER, "scavenger", 10, 25000, 1,
          "This talent grants access to the salvage command. Note that having both the Scavenger "
  ...
  talento(TALENT_PROFICIENT_WOODWORKING, "proficient woodworking", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the woodworking skill.", TRUE,
          TALENT_CAT_WOODWORKING);
  talento(TALENT_RAPID_WOODWORKING, "rapid woodworking", 1, 1000, 10,
          "-2 seconds on woodworking skill task completion per rank",
          "Reduces completion time for tasks performed with the woodworking skill by 2 seconds per "
          "rank.",
          TRUE, TALENT_CAT_WOODWORKING);
  talento(TALENT_WOODWORKING_EXPERTISE, "woodworking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the woodworking skill.",
          TRUE, TALENT_CAT_WOODWORKING);
  talento(TALENT_EFFICIENT_WOODWORKING, "efficient woodworking", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the "
          "woodworking skill.",
          TRUE, TALENT_CAT_WOODWORKING);
  talento(TALENT_INSIGHTFUL_WOODWORKING, "insightful woodworking", 2, 5000, 5,
          "+5% experience per rank on woodworking tasks",
          "Each rank gives a 5% bonus to experience gained when performing woodworking tasks.",
          TRUE, TALENT_CAT_WOODWORKING);

  /* Tailoring talents */
  talento(TALENT_PROFICIENT_TAILORING, "proficient tailoring", 1, 1000, 5,
          "+1 to skill checks for the tailoring skill",
          "Each rank gives +1 to skill checks made with the tailoring skill.", TRUE,
          TALENT_CAT_TAILORING);
  talento(
      TALENT_RAPID_TAILORING, "rapid tailoring", 1, 1000, 10,
      "-2 seconds on tailoring skill task completion per rank",
      "Reduces completion time for tasks performed with the tailoring skill by 2 seconds per rank.",
      TRUE, TALENT_CAT_TAILORING);
  talento(TALENT_TAILORING_EXPERTISE, "tailoring expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the tailoring skill.", TRUE,
          TALENT_CAT_TAILORING);
  talento(TALENT_EFFICIENT_TAILORING, "efficient tailoring", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the tailoring "
          "skill.",
          TRUE, TALENT_CAT_TAILORING);
  talento(TALENT_INSIGHTFUL_TAILORING, "insightful tailoring", 2, 5000, 5,
          "+5% experience per rank on tailoring tasks",
          "Each rank gives a 5% bonus to experience gained when performing tailoring tasks.", TRUE,
          TALENT_CAT_TAILORING);

  /* Alchemy talents */
  talento(TALENT_PROFICIENT_ALCHEMY, "proficient alchemy", 1, 1000, 5,
          "+1 to skill checks for the alchemy skill",
          "Each rank gives +1 to skill checks made with the alchemy skill.", TRUE,
          TALENT_CAT_ALCHEMY);
  talento(
      TALENT_RAPID_ALCHEMY, "rapid alchemy", 1, 1000, 10,
      "-2 seconds on alchemy skill task completion per rank",
      "Reduces completion time for tasks performed with the alchemy skill by 2 seconds per rank.",
      TRUE, TALENT_CAT_ALCHEMY);
  talento(TALENT_ALCHEMY_EXPERTISE, "alchemy expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the alchemy skill.", TRUE,
          TALENT_CAT_ALCHEMY);
  talento(TALENT_EFFICIENT_ALCHEMY, "efficient alchemy", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the alchemy "
          "skill.",
          TRUE, TALENT_CAT_ALCHEMY);
  talento(TALENT_INSIGHTFUL_ALCHEMY, "insightful alchemy", 2, 5000, 5,
          "+5% experience per rank on alchemy tasks",
          "Each rank gives a 5% bonus to experience gained when performing alchemy tasks.", TRUE,
          TALENT_CAT_ALCHEMY);
  ...
  talento(TALENT_PROFICIENT_ARMORSMITHING, "proficient armorsmithing", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the armorsmithing skill.", TRUE,
          TALENT_CAT_ARMORSMITHING);
  talento(TALENT_RAPID_ARMORSMITHING, "rapid armorsmithing", 1, 1000, 10,
          ...
          "Reduces completion time for tasks performed with the armorsmithing skill by 2 seconds "
          "per rank.",
          TRUE, TALENT_CAT_ARMORSMITHING);
  talento(TALENT_ARMORSMITHING_EXPERTISE, "armorsmithing expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the armorsmithing skill.",
          TRUE, TALENT_CAT_ARMORSMITHING);
  ...
  talento(TALENT_INSIGHTFUL_ARMORSMITHING, "insightful armorsmithing", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing armorsmithing tasks.",
          TRUE, TALENT_CAT_ARMORSMITHING);
  ...
  talento(TALENT_PROFICIENT_WEAPONSMITHING, "proficient weaponsmithing", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the weaponsmithing skill.", TRUE,
          TALENT_CAT_WEAPONSMITHING);
  talento(TALENT_RAPID_WEAPONSMITHING, "rapid weaponsmithing", 1, 1000, 10,
          ...
          "Reduces completion time for tasks performed with the weaponsmithing skill by 2 seconds "
          "per rank.",
          TRUE, TALENT_CAT_WEAPONSMITHING);
  talento(TALENT_WEAPONSMITHING_EXPERTISE, "weaponsmithing expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the weaponsmithing skill.",
          TRUE, TALENT_CAT_WEAPONSMITHING);
  ...
  talento(TALENT_INSIGHTFUL_WEAPONSMITHING, "insightful weaponsmithing", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing weaponsmithing tasks.",
          TRUE, TALENT_CAT_WEAPONSMITHING);

  /* Bowmaking talents */
  talento(TALENT_PROFICIENT_BOWMAKING, "proficient bowmaking", 1, 1000, 5,
          "+1 to skill checks for the bowmaking skill",
          "Each rank gives +1 to skill checks made with the bowmaking skill.", FALSE,
          TALENT_CAT_BOWMAKING);
  talento(
      TALENT_RAPID_BOWMAKING, "rapid bowmaking", 1, 1000, 10,
      "-2 seconds on bowmaking skill task completion per rank",
      "Reduces completion time for tasks performed with the bowmaking skill by 2 seconds per rank.",
      FALSE, TALENT_CAT_BOWMAKING);
  talento(TALENT_BOWMAKING_EXPERTISE, "bowmaking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the bowmaking skill.", FALSE,
          TALENT_CAT_BOWMAKING);
  talento(TALENT_EFFICIENT_BOWMAKING, "efficient bowmaking", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the bowmaking "
          "skill.",
          FALSE, TALENT_CAT_BOWMAKING);
  talento(TALENT_INSIGHTFUL_BOWMAKING, "insightful bowmaking", 2, 5000, 5,
          "+5% experience per rank on bowmaking tasks",
          "Each rank gives a 5% bonus to experience gained when performing bowmaking tasks.", FALSE,
          TALENT_CAT_BOWMAKING);
  ...
  talento(TALENT_PROFICIENT_JEWELCRAFTING, "proficient jewelcrafting", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the jewelcrafting skill.", TRUE,
          TALENT_CAT_JEWELCRAFTING);
  talento(TALENT_RAPID_JEWELCRAFTING, "rapid jewelcrafting", 1, 1000, 10,
          ...
          "Reduces completion time for tasks performed with the jewelcrafting skill by 2 seconds "
          "per rank.",
          TRUE, TALENT_CAT_JEWELCRAFTING);
  talento(TALENT_JEWELCRAFTING_EXPERTISE, "jewelcrafting expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the jewelcrafting skill.",
          TRUE, TALENT_CAT_JEWELCRAFTING);
  ...
  talento(TALENT_INSIGHTFUL_JEWELCRAFTING, "insightful jewelcrafting", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing jewelcrafting tasks.",
          TRUE, TALENT_CAT_JEWELCRAFTING);
  ...
  talento(TALENT_PROFICIENT_LEATHERWORKING, "proficient leatherworking", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the leatherworking skill.", TRUE,
          TALENT_CAT_LEATHERWORKING);
  talento(TALENT_RAPID_LEATHERWORKING, "rapid leatherworking", 1, 1000, 10,
          ...
          "Reduces completion time for tasks performed with the leatherworking skill by 2 seconds "
          "per rank.",
          TRUE, TALENT_CAT_LEATHERWORKING);
  talento(TALENT_LEATHERWORKING_EXPERTISE, "leatherworking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the leatherworking skill.",
          TRUE, TALENT_CAT_LEATHERWORKING);
  ...
  talento(TALENT_INSIGHTFUL_LEATHERWORKING, "insightful leatherworking", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing leatherworking tasks.",
          TRUE, TALENT_CAT_LEATHERWORKING);

  /* Trapmaking talents */
  talento(TALENT_PROFICIENT_TRAPMAKING, "proficient trapmaking", 1, 1000, 5,
          "+1 to skill checks for the trapmaking skill",
          "Each rank gives +1 to skill checks made with the trapmaking skill.", FALSE,
          TALENT_CAT_TRAPMAKING);
  talento(TALENT_RAPID_TRAPMAKING, "rapid trapmaking", 1, 1000, 10,
          "-2 seconds on trapmaking skill task completion per rank",
          "Reduces completion time for tasks performed with the trapmaking skill by 2 seconds per "
          "rank.",
          FALSE, TALENT_CAT_TRAPMAKING);
  talento(TALENT_TRAPMAKING_EXPERTISE, "trapmaking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the trapmaking skill.",
          FALSE, TALENT_CAT_TRAPMAKING);
  ...
  talento(TALENT_INSIGHTFUL_TRAPMAKING, "insightful trapmaking", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing trapmaking tasks.",
          FALSE, TALENT_CAT_TRAPMAKING);
  ...
  talento(TALENT_PROFICIENT_POISONMAKING, "proficient poisonmaking", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the poisonmaking skill.", FALSE,
          TALENT_CAT_POISONMAKING);
  talento(TALENT_RAPID_POISONMAKING, "rapid poisonmaking", 1, 1000, 10,
          "-2 seconds on poisonmaking skill task completion per rank",
          "Reduces completion time for tasks performed with the poisonmaking skill by 2 seconds "
          "per rank.",
          FALSE, TALENT_CAT_POISONMAKING);
  talento(TALENT_POISONMAKING_EXPERTISE, "poisonmaking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the poisonmaking skill.",
          FALSE, TALENT_CAT_POISONMAKING);
  ...
  talento(TALENT_INSIGHTFUL_POISONMAKING, "insightful poisonmaking", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing poisonmaking tasks.",
          FALSE, TALENT_CAT_POISONMAKING);
  ...
  talento(TALENT_PROFICIENT_METALWORKING, "proficient metalworking", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the metalworking skill.", TRUE,
          TALENT_CAT_METALWORKING);
  talento(TALENT_RAPID_METALWORKING, "rapid metalworking", 1, 1000, 10,
          "-2 seconds on metalworking skill task completion per rank",
          "Reduces completion time for tasks performed with the metalworking skill by 2 seconds "
          "per rank.",
          TRUE, TALENT_CAT_METALWORKING);
  talento(TALENT_METALWORKING_EXPERTISE, "metalworking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the metalworking skill.",
          TRUE, TALENT_CAT_METALWORKING);
  ...
  talento(TALENT_INSIGHTFUL_METALWORKING, "insightful metalworking", 2, 5000, 5,
          ...
          "Each rank gives a 5% bonus to experience gained when performing metalworking tasks.",
          TRUE, TALENT_CAT_METALWORKING);

  /* Fishing talents */
  talento(TALENT_PROFICIENT_FISHING, "proficient fishing", 1, 1000, 5,
          "+1 to skill checks for the fishing skill",
          "Each rank gives +1 to skill checks made with the fishing skill.", FALSE,
          TALENT_CAT_FISHING);
  talento(
      TALENT_RAPID_FISHING, "rapid fishing", 1, 1000, 10,
      "-2 seconds on fishing skill task completion per rank",
      "Reduces completion time for tasks performed with the fishing skill by 2 seconds per rank.",
      FALSE, TALENT_CAT_FISHING);
  talento(TALENT_FISHING_EXPERTISE, "fishing expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the fishing skill.", FALSE,
          TALENT_CAT_FISHING);
  talento(TALENT_EFFICIENT_FISHING, "efficient fishing", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the fishing "
          "skill.",
          FALSE, TALENT_CAT_FISHING);
  talento(TALENT_INSIGHTFUL_FISHING, "insightful fishing", 2, 5000, 5,
          "+5% experience per rank on fishing tasks",
          "Each rank gives a 5% bonus to experience gained when performing fishing tasks.", FALSE,
          TALENT_CAT_FISHING);

  /* Cooking talents */
  talento(TALENT_PROFICIENT_COOKING, "proficient cooking", 1, 1000, 5,
          "+1 to skill checks for the cooking skill",
          "Each rank gives +1 to skill checks made with the cooking skill.", FALSE,
          TALENT_CAT_COOKING);
  talento(
      TALENT_RAPID_COOKING, "rapid cooking", 1, 1000, 10,
      "-2 seconds on cooking skill task completion per rank",
      "Reduces completion time for tasks performed with the cooking skill by 2 seconds per rank.",
      FALSE, TALENT_CAT_COOKING);
  talento(TALENT_COOKING_EXPERTISE, "cooking expertise", 2, 2500, 5,
          "+1% chance to critical success when crafting",
          "+1% chance to critical success when crafting something with the cooking skill.", FALSE,
          TALENT_CAT_COOKING);
  talento(TALENT_EFFICIENT_COOKING, "efficient cooking", 1, 2500, 10,
          "3% chance per rank to save half materials",
          "Each rank gives a 3% chance to save half the materials when crafting with the cooking "
          "skill.",
          FALSE, TALENT_CAT_COOKING);
  talento(TALENT_INSIGHTFUL_COOKING, "insightful cooking", 2, 5000, 5,
          "+5% experience per rank on cooking tasks",
          "Each rank gives a 5% bonus to experience gained when performing cooking tasks.", FALSE,
          TALENT_CAT_COOKING);
  ...
  talento(TALENT_PROFICIENT_MINING, "proficient mining", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the mining skill.", TRUE,
          TALENT_CAT_MINING);
  talento(TALENT_RAPID_MINING, "rapid mining", 1, 1000, 5,
          "-1 second on mining skill task completion per rank",
          "Reduces completion time for tasks performed with the mining skill by 1 second per rank.",
          TRUE, TALENT_CAT_MINING);
  talento(TALENT_MINING_EXPERTISE, "mining expertise", 2, 2500, 5,
          "On critical success, chance to gain extra materials",
          "On critical success when mining there's a 10% chance per rank to gain extra materials.",
          TRUE, TALENT_CAT_MINING);
  talento(
      TALENT_EFFICIENT_MINING, "efficient mining", 1, 2500, 10,
      "3% chance per rank to gain 2 extra units",
      "Each rank gives a 3% chance to gain 2 extra units when harvesting with the mining skill.",
      TRUE, TALENT_CAT_MINING);
  talento(TALENT_INSIGHTFUL_MINING, "insightful mining", 2, 5000, 5,
          "+5% experience per rank on mining tasks",
          "Each rank gives a 5% bonus to experience gained when performing mining tasks.", TRUE,
          TALENT_CAT_MINING);
  ...
  talento(TALENT_PROFICIENT_HUNTING, "proficient hunting", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the hunting skill.", TRUE,
          TALENT_CAT_HUNTING);
  talento(
      TALENT_RAPID_HUNTING, "rapid hunting", 1, 1000, 5,
      "-1 second on hunting skill task completion per rank",
      "Reduces completion time for tasks performed with the hunting skill by 1 second per rank.",
      TRUE, TALENT_CAT_HUNTING);
  talento(TALENT_HUNTING_EXPERTISE, "hunting expertise", 2, 2500, 5,
          "On critical success, chance to gain extra materials",
          "On critical success when hunting there's a 10% chance per rank to gain extra materials.",
          TRUE, TALENT_CAT_HUNTING);
  talento(
      TALENT_EFFICIENT_HUNTING, "efficient hunting", 1, 2500, 10,
      "3% chance per rank to gain 2 extra units",
      "Each rank gives a 3% chance to gain 2 extra units when harvesting with the hunting skill.",
      TRUE, TALENT_CAT_HUNTING);
  talento(TALENT_INSIGHTFUL_HUNTING, "insightful hunting", 2, 5000, 5,
          "+5% experience per rank on hunting tasks",
          "Each rank gives a 5% bonus to experience gained when performing hunting tasks.", TRUE,
          TALENT_CAT_HUNTING);
  ...
  talento(TALENT_PROFICIENT_FORESTRY, "proficient forestry", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the forestry skill.", TRUE,
          TALENT_CAT_FORESTRY);
  talento(
      TALENT_RAPID_FORESTRY, "rapid forestry", 1, 1000, 5,
      "-1 second on forestry skill task completion per rank",
      "Reduces completion time for tasks performed with the forestry skill by 1 second per rank.",
      TRUE, TALENT_CAT_FORESTRY);
  talento(TALENT_FORESTRY_EXPERTISE, "forestry expertise", 2, 2500, 5,
          "On critical success, chance to gain extra materials",
          "On critical success when harvesting wood there's a 10% chance per rank to gain extra "
          "materials.",
          TRUE, TALENT_CAT_FORESTRY);
  talento(
      TALENT_EFFICIENT_FORESTRY, "efficient forestry", 1, 2500, 10,
      "3% chance per rank to gain 2 extra units",
      "Each rank gives a 3% chance to gain 2 extra units when harvesting with the forestry skill.",
      TRUE, TALENT_CAT_FORESTRY);
  talento(TALENT_INSIGHTFUL_FORESTRY, "insightful forestry", 2, 5000, 5,
          "+5% experience per rank on forestry tasks",
          "Each rank gives a 5% bonus to experience gained when performing forestry tasks.", TRUE,
          TALENT_CAT_FORESTRY);
  ...
  talento(TALENT_PROFICIENT_GATHERING, "proficient gathering", 1, 1000, 5,
          ...
          "Each rank gives +1 to skill checks made with the gathering skill.", TRUE,
          TALENT_CAT_GATHERING);
  talento(
      TALENT_RAPID_GATHERING, "rapid gathering", 1, 1000, 5,
      "-1 second on gathering skill task completion per rank",
      "Reduces completion time for tasks performed with the gathering skill by 1 second per rank.",
      TRUE, TALENT_CAT_GATHERING);
  talento(
      TALENT_GATHERING_EXPERTISE, "gathering expertise", 2, 2500, 5,
      "On critical success, chance to gain extra materials",
      "On critical success when gathering there's a 10% chance per rank to gain extra materials.",
      TRUE, TALENT_CAT_GATHERING);
  talento(
      TALENT_EFFICIENT_GATHERING, "efficient gathering", 1, 2500, 10,
      "3% chance per rank to gain 2 extra units",
      "Each rank gives a 3% chance to gain 2 extra units when harvesting with the gathering skill.",
      TRUE, TALENT_CAT_GATHERING);
...
{
  if (!ch || talent <= 0 || talent >= TALENT_MAX)
    return 0;
  int rank = current_rank(ch, talent);
  if (rank >= talent_max_ranks(talent))
    return 0;
...
int can_learn_talent(struct char_data *ch, int talent)
{
  ...
  if (p_cost <= 0)
    return 0;
  if (GET_TALENT_POINTS(ch) < p_cost)
    return 0;
  if (g_cost > 0 && GET_GOLD(ch) < g_cost)
    return 0;
  return 1;
}
...
{
  if (!can_learn_talent(ch, talent))
    return 0;
  int p_cost = talent_next_point_cost(ch, talent);
  int g_cost = talent_next_gold_cost(ch, talent);
  /* Deduct costs */
  if (p_cost > 0)
    GET_TALENT_POINTS(ch) -= p_cost;
  if (g_cost > 0)
  {
  ...
  if (rank == 0)
    ...
    send_to_char(ch, "\tGYou improve %s to rank %d/%d!\tn\r\n", talent_list[talent].name, rank + 1,
                 talent_max_ranks(talent));
...
void show_talent_info(struct char_data *ch, int talent)
{
  ...
  int r, base_pt = talent_list[talent].base_point_cost,
         base_gp = talent_list[talent].base_gold_cost;
  ...
  if (is_abbrev(arg1, "learn"))
  {
    ...
    if (!can_learn_talent(ch, num))
    {
      if (rank >= maxr)
        ...
        send_to_char(ch,
                     "You need \tR%d talent point%s\tn (you have %d) to learn the next rank.\r\n",
    ...
    if (learn_talent(ch, num))
    {
      send_to_char(ch, "Remaining: %d talent point%s, %d gold\r\n", GET_TALENT_POINTS(ch),
                   GET_TALENT_POINTS(ch) == 1 ? "" : "s", GET_GOLD(ch));
      return;
    }
...
ACMD(do_talento)
{
  ...
  if (is_abbrev(arg2, "points"))
  {
    ...
    mudlog(NRM, MAX(LVL_IMMORT, GET_INVIS_LEV(ch)), TRUE, "(GC) %s set %s's talent points to %d",
  ...
  if (!*arg3)
  {
    ...
    send_to_char(ch, "%s's talent '%s': Rank %d/%d\r\n", GET_NAME(vict),
                 talent_list[talent_num].name, rank, maxr);
    return;
  }
  ...
  send_to_char(vict, "Your talent '%s' has been set to rank %d by an immortal.\r\n",
               talent_list[talent_num].name, value);
  mudlog(NRM, MAX(LVL_IMMORT, GET_INVIS_LEV(ch)), TRUE, "(GC) %s set %s's talent '%s' to rank %d",
